    ...
    <footer className="bg-bg-deepest border-t border-border-subtle pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        <div>
          ...
          <p className="mb-4">Serving Central Louisiana for over 20 years with premium remanufactured automotive solutions.</p>
          <p className="mb-6 text-blue-primary font-semibold text-sm">We accept all VSC (Vehicle Service Contracts) warranties. Also called 3rd party warranties.</p>
    ...
    <div className="overflow-hidden">
      ...
      <section className="bg-blue-primary py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-center text-white/90 max-w-xl mx-auto mb-6">Our rebuilds go beyond factory spec — addressing the weak points that cause common failures. That's why we can stand behind a 3-Year Nationwide Unlimited Mileage Warranty with confidence.</p>
          <p className="text-center text-white font-bold max-w-xl mx-auto mb-10">We accept all VSC (Vehicle Service Contracts) warranties. Also called 3rd party warranties.</p>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mb-4">Both our engines and transmissions are backed by a Nationwide 3-Year, Unlimited Mileage Warranty, honored anywhere in the country.</p>
            <p className="mb-8 text-blue-primary font-bold">We accept all VSC (Vehicle Service Contracts) warranties. Also called 3rd party warranties.</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
